...
defined('UNLIMITED_ELEMENTS_INC') or die('Restricted access');
	...
	class UniteFunctionsWPUC{
		 ...
		 */
		private static function getTermsObjectsData($arrTerms, $taxonomyName){
			$arrTermData = array();
		...
		public static function getArrSortBy(){
			...
			$arr[self::SORTBY_MENU_ORDER] = "Menu Order";
			$arr[self::SORTBY_PARENT] = "Parent Post";
			$arr[self::SORTBY_META_VALUE] = "Custom Field Value";
			$arr[self::SORTBY_META_VALUE_NUM] = "Custom Field Value (numeric)";
